...
export default function Navbar() {
  ...
  const handleLinkClick = (
    ...
    // If it's a regular route (not a hash link), navigate directly
    if (!href.startsWith("#")) {
  ...
  const getHref = (href: string) => {
    // If it's a regular route, return as-is
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 relative">
        <div className="flex items-center justify-between">
          ...
          >
            ...
            <span
              className={`font-display font-bold surgical-gradient-text hidden sm:block transition-all duration-300 ${
      ...
      <motion.div
        className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-teal-400 to-blue-600 origin-left"
        style={{ scaleX }}
      />
    </motion.nav>
  );
